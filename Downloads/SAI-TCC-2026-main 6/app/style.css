...
:root {
    --font-tech: var(--font-sharetech);
}

body {
    font-family: var(--font-tech), ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
}
...
.segment__grid-item dt {
    font-weight: 700;
    font-size: 0.9rem;
    color: #111827;
}

.segment__grid-item dd {
    margin: 4px 0 0;
    color: #4b5563;
}
